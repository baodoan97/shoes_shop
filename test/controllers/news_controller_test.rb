...
class NewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news" do
    assert_difference('New.count') do
      post news_url, params: { news: { body: @news.body, product_id: @news.product_id, title: @news.title } }
    end
  ...
  test "should update news" do
    patch news_url(@news), params: { news: { body: @news.body, product_id: @news.product_id, title: @news.title } }
